...
def create_sunburst(unitRadios, tagsLayers, currencyRadios, priceSlider):
    ...
    sunburst['pattern_shape_sequence'] = ["/" if i % 2 == 0 else "\\" for i in range(len(sunburst))]
    sunburst['bgcolor'] = ["#333" if i % 2 == 0 else "#EEE" for i in range(len(sunburst))]
...
controls = dbc.Stack(
            ...
            dbc.Col(dbc.Alert([
                html.H6([
                    ...
                    dbc.Badge(["by ", html.A("hefnermw.", href = "https://community.plotly.com/u/hefnermw/activity")], pill=True, color="secondary", className="me-1")
                    ]),
                html.Div(style={"minWidth" : "100px"}),
                "This app was made in under a week with the Dash framework. Read about this week's challenge and my reflections on it ",
            ...
            dbc.Col(dbc.Alert([
                dbc.Badge("Plotly Community", pill=True, color="dark", href="https://community.plotly.com", target="_blank", className="me-1 p-2"),
                dbc.Badge("Source on GitHub", pill=True, color="dark", href="https://github.com/your-repo-url", target="_blank", className="me-1 p-2"),
                dbc.Badge("MIT License", pill=True, color="dark", href="https://opensource.org/licenses/MIT", target="_blank", className="p-2")
                ], 
                color="dark",
                className="mb-3", 
